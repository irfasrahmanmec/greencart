...
const Navbar = () => {
  ...
  const {user, setUser, showUserLogin, setShowUserLogin, 
    searchQuery, setSearchQuery, getCartCount } = useAppContext();
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                (
                 <div className='relative group'>   
                    ...
                    <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py2.5 w-30 rounded-md text-sm z-40'> 
